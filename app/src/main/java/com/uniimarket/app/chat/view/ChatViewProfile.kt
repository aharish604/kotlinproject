...
import com.uniimarket.app.SellerProfile.view.SellerProductsAdapter
import com.uniimarket.app.more.favourites.view.FavouriteProductDetailsFragment

class ChatViewProfile(val uid: String) : Fragment(), SellerProfilePresenter.SellerProfileListener {
    ...
    override fun onCreateView(
        ...
        (context as DashboardActivity).ll_back?.setOnClickListener {
            ...
            (context as DashboardActivity).replaceFragment(
                R.id.frame_layout,
                ChatViewFragment(uid + ""), false, false
            )
...
//            sellerProfilePresenter?.updateNotificationStatus(uid)
    ...
    private fun getNotificationStatus() {
        ...
        progressDialog?.setCancelable(false)
        progressDialog?.show()
        sellerProfilePresenter?.getNotificationStatus(uid)
    }
    ...
    private fun getSellerDetails() {
        ...
        progressDialog?.setCancelable(false)
        progressDialog?.show()
        sellerProfilePresenter?.getSellerProfileDetails(uid)
