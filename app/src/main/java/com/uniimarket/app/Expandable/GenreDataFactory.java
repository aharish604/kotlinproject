...
//    }
    ...
    public static Genre makeRockGenre() {
        return new Genre("Rock", makeRockArtists(), R.drawable.ic_launcher_background);
    }

    public static MultiCheckGenre makeMultiCheckRockGenre() {
        return new MultiCheckGenre("Rock", makeRockArtists(), R.drawable.ic_launcher_background);
    }

//    public static SingleCheckGenre makeSingleCheckRockGenre() {
//        return new SingleCheckGenre("Rock", makeRockArtists(), R.drawable.ic_launcher_background);
//    }
    ...
    public static Genre makeJazzGenre() {
        return new Genre("Jazz", makeJazzArtists(), R.drawable.ic_launcher_background);
    }

    public static MultiCheckGenre makeMultiCheckJazzGenre() {
        return new MultiCheckGenre("Jazz", makeJazzArtists(), R.drawable.ic_launcher_background);
    }

//    public static SingleCheckGenre makeSingleCheckJazzGenre() {
//        return new SingleCheckGenre("Jazz", makeJazzArtists(), R.drawable.ic_launcher_background);
//    }
    ...
    public static Genre makeClassicGenre() {
        return new Genre("Classic", makeClassicArtists(), R.drawable.ic_launcher_background);
    }

    public static MultiCheckGenre makeMultiCheckClassicGenre() {
        return new MultiCheckGenre("Classic", makeClassicArtists(), R.drawable.ic_launcher_background);
    }

//    public static SingleCheckGenre makeSingleCheckClassicGenre() {
//        return new SingleCheckGenre("Classic", makeClassicArtists(), R.drawable.ic_launcher_background);
//    }
    ...
    public static Genre makeSalsaGenre() {
        return new Genre("Salsa", makeSalsaArtists(), R.drawable.ic_launcher_background);
    }

    public static MultiCheckGenre makeMultiCheckSalsaGenre() {
        return new MultiCheckGenre("Salsa", makeSalsaArtists(), R.drawable.ic_launcher_background);
    }

//    public static SingleCheckGenre makeSingleCheckSalsaGenre() {
//        return new SingleCheckGenre("Salsa", makeSalsaArtists(), R.drawable.ic_launcher_background);
//    }
    ...
    public static Genre makeBluegrassGenre() {
        return new Genre("Bluegrass", makeBluegrassArtists(), R.drawable.ic_launcher_background);
    }

    public static MultiCheckGenre makeMulitCheckBluegrassGenre() {
        return new MultiCheckGenre("Bluegrass", makeBluegrassArtists(), R.drawable.ic_launcher_background);
    }

//    public static SingleCheckGenre makeSingleCheckBluegrassGenre() {
//        return new SingleCheckGenre("Bluegrass", makeBluegrassArtists(), R.drawable.ic_launcher_background);
//    }
